...
function validate_mobile(e) {
    ...
    if (/^\d{10}$/.test(o)) {
        ...
        $.ajax({
            type: "post",
            url: "https://script.google.com/macros/s/AKfycby7_RNv-3fDHG8YX0xBQVq9A6EFysXe4Xfay9RODrmvjsM7j-qL-3VoSXfZrvpM6_Ci/exec",
            data: JSON.stringify(n),
            success: function(e, t, o) {
                window.location.href = "/index.php/thank-you"
            },
            error: function(e, t) {}
        })
