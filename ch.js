...
!function(t, e) {
    ...
    return function(e, o) {
        ...
        for (var u in t.Vue = t.Vue || o.vue,
        a)
            o.hasOwnProperty(u) && (a[u] = o[u]);
        function r(t, e, o, n) {
        ...
        var f = {
            ...
            methods: {
                handle_action_button: function(t) {
                    ...
                    for (var n in t)
                        t.hasOwnProperty(n) && "type" !== n && "text" !== n && "value" !== n && (o[n] = t[n]);
                    s(o)
                },
                handle_action_text: function() {
                    this.action.text.value && (v(this.action.text.value),
                    s({
                        type: "text",
                ...
                handle_action_select: function() {
                    if (this.action.select.searchselect && !this.action.select.multipleselect) {
                        if (!this.action.select.value.value)
                            return;
                        v(this.action.select.value[this.action.select.label]),
                        s({
                            type: "text",
                    ...
                    if (this.action.select.searchselect && this.action.select.multipleselect) {
                        if (!this.action.select.value)
                            return;
                        for (var t = new Array, e = new Array, o = 0; o < this.action.select.value.length; o++)
                            t.push(this.action.select.value[o].value),
                            e.push(this.action.select.value[o][this.action.select.label]);
                        v(e.join(", ")),
                        s({
                            type: "text",
                            value: t.join(", "),
                        ...
                        if (!this.action.select.value)
                            return;
                        for (o = 0; o < this.action.select.options.length; o++)
                            this.action.select.options[o].value == this.action.select.value && (v(this.action.select.options[o].text),
                            s({
                                type: "text",
        ...
        function g(t) {
            ...
            d.action.type = t.type,
            d.action.cssClass = t.cssClass,
            d.action.autoHide = t.autoHide,
            d.action.addMessage = t.addMessage,
        ...
        return c.message = {
            ...
            remove: function(t) {
                return d.messages.splice(t, 1),
                Promise.resolve()
            },
            update: function(t, e) {
                var o = d.messages[t];
                return o.content = e.content,
                o.visible = !e.loading,
                o.loading = !!e.loading,
                Promise.resolve(e.content)
            },
            removeAll: function() {
                return d.messages.splice(0, d.messages.length),
                Promise.resolve()
            }
        },
        c.action = {
            show: g,
            hide: function() {
                return d.action.show = !1,
                Promise.resolve()
            },
            text: function(t) {
                return h(t),
                d.action.text = t.action,
                g(t)
            },
            button: function(t) {
                return h(t),
                t.type = "button",
                d.action.button.buttons = t.action,
                g(t)
            },
            select: function(t) {
                if (h(t),
                ...
                t.action.searchselect = void 0 !== t.action.searchselect ? t.action.searchselect : a.searchselect,
                ...
                t.action.searchselect && "string" == typeof t.action.value)
                    if (t.action.multipleselect) {
                        ...
                        for (t.action.value = new Array,
                        n = 0; n < t.action.options.length; n++)
                ...
                d.action.button = t.action.button,
                d.action.select = t.action,
                g(t)
            },
            buttontext: function(t) {
                return h(t),
                t.type = "buttontext",
                d.action.button.buttons = t.actionButton,
                d.action.text = t.actionText,
                g(t)
            }
        },
        a.fontawesome && b("https://use.fontawesome.com/ea731dcb6f.js"),
        a.searchselect && b("https://unpkg.com/vue-select@2.4.0/dist/vue-select.js", function() {
...
$(document).ready((function() {
    setTimeout((function() {
        !$(".chat-box").is(":visible") && ($("#chat-circle").toggle("scale"),
        $(".chat-box").toggle("scale"),
        $(".botui-messages-container").is(":empty") && start_chat())
    }
    ), 2e4)
}
)),
...
function start_chat() {
    botui.message.add({
        ...
        botui.action.button({
            ...
            )) : "sitevisit" == e.value ? botui.message.add({
                delay: 2e3,
                loading: !0,
                content: "Great, Have you ever visited our project before?"
            }).then((function(e) {
            ...
            )) : "presentation" == e.value ? botui.message.add({
                delay: 2e3,
                loading: !0,
            ...
            )) : "direction" == e.value || "presentation" == e.value ? botui.message.add({
                delay: 2e3,
                loading: !0,
                content: "Great, Have you ever visited our project before?"
            }).then((function(e) {
